...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <form method="POST" action="{{ route('logout') }}">
                  {{ csrf_field() }}
                  <button href="#" class="btn btn-default btn-flat btn-block">Cerrar sesión</button>
                </form>
              </li>
            </ul>
          </li>
    ...
    <section class="content container-fluid">
		  ...
		  @if(session()->has('flash'))
		    <div class="alert alert-success alert-dismissible">
		      <i class="icon fa fa-check"></i>{{ session('flash') }}
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a>Daniel Baez</a>.</strong> All rights reserved.
  </footer>
