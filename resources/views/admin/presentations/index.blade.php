...
@section('header')
	<h1>
		PRESENTACIONES <button type="button" class="btn btn-success pull-right" data-toggle="modal" data-target="#modal-presentation-create">
...
<div class="row">
	...
	@include('admin.presentations.edit')
	@include('admin.presentations.delete')

    <div class="col-xs-12">
    	<div class="box box-primary">
            <div class="box-body">
            	<div class="table-responsive">
	            	<table class="table table-bordered table-hover table-width-100" id="presentations" data-url="{{ route('admin.presentations.ajaxPresentations') }}" data-url-image="{{asset('images/usuarios')}}">
				  		<thead>
				  			<th class="r">ID</th>
...
@push('scripts')
	...
	<script src="{{ asset('js/admin/presentations.js') }}"></script>
@endpush