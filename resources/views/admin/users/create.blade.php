<div class="modal fade" id="modal-user-create">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form method="POST" action="{{ route('admin.users.store') }}" id="form-user-create" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="row">				            
		              	...
		              	<div class="col-xs-6">
			                ...
			                <div class="form-group">
			                  ...
			                  <input name="birth_date" type="text" class="form-control birth_date" id="birth_date" placeholder="Fecba de nacimiento">
			                </div>
			                <div class="form-group">
