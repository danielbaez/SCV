...
@section('header')
	<h1>
		CLIENTES <button type="button" class="btn btn-success pull-right" data-toggle="modal" data-target="#modal-customer-create">
    	...
    	<div class="box box-primary">
            <div class="box-body">
            	<div class="table-responsive">
	            	<table class="table table-bordered table-hover table-width-100" id="customers" data-url="{{ route('admin.customers.ajaxCustomers') }}" data-url-image="{{asset('images/usuarios')}}">
				  		<thead>
				  			<th class="r">ID</th>
