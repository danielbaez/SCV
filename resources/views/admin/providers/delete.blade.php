<div class="modal modal-danger fade" id="modal-provider-delete">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form method="POST" action="" id="form-provider-delete">
				{{ method_field('DELETE') }}
				<div class="modal-body">
					<div class="row">				            
		              	<div class="col-xs-12">
		              		¿Está seguro que quiere desactivar este proveedor?
		              	</div>			            
					</div>
				</div>
