...
@section('header')
	<h1 id="header-sales-index">
		{{-- Ventas <button type="button" class="btn btn-success pull-right" id="form-purchase-create">
		<i class="fa fa-plus"></i> CREAR</button> --}}
		Ventas <a href="{{ route('admin.sales.create') }}" class="btn btn-success pull-right" id="form-purchase-create">
		<i class="fa fa-plus"></i> CREAR</a>
	</h1>
	<h1 id="header-sales-create" style="display: none">
    	...
    	<div class="box box-primary">
            <div class="box-body">
            	<div class="table-responsive">
	            	<table class="table table-bordered table-hover table-width-100" id="sales" data-url="{{ route('admin.sales.ajaxSales') }}" data-url-image="{{asset('images/usuarios')}}">
				  		<thead>
				  			<th class="r">ID</th>
				  			<th class="r">Cliente</th>
