$(document).ready(function() {
  ...
  //***DataTable***
  dataTableSimple('vouchers', 'reporte-comprobantes', 'Lista de comprobantes', [6], [0, 1, 2, 3, 4, 5], 'portrait', 'A4', 8);

  //create
  storeR('form-voucher-create', num);
  //update
